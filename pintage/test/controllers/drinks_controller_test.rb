...
class DrinksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create drink" do
    assert_difference('Drink.count') do
      post drinks_url, params: { drink: { name: @drink.name, price: @drink.price, quantity: @drink.quantity, units: @drink.units, user_id: @drink.user_id } }, as: :json
    end
  ...
  test "should update drink" do
    patch drink_url(@drink), params: { drink: { name: @drink.name, price: @drink.price, quantity: @drink.quantity, units: @drink.units, user_id: @drink.user_id } }, as: :json
    assert_response 200
  end
